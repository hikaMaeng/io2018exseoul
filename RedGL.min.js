...
*/},(RedPostEffect_FXAA=function(r){if(!(this instanceof RedPostEffect_FXAA))return new RedPostEffect_FXAA(r);r instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_FXAA : RedGL Instance만 허용됩니다.",r),this.frameBuffer=RedFrameBuffer(r),this.diffuseTexture=null,this.program=RedProgram.makeProgram(r,"RedPostEffect_FXAA_Program",e,t),this._UUID=RedGL.makeUUID(),this.updateTexture=function(e){this.diffuseTexture=e},this.bind=RedPostEffectManager.prototype.bind,this.unbind=RedPostEffectManager.prototype.unbind,this.checkUniformAndProperty()}).prototype=new RedBaseMaterial,Object.freeze(RedPostEffect_FXAA)}();console.log('RedGL Release. last update(2018-06-07 21:06:09)');